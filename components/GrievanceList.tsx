                ...
                sortedAndFilteredGrievances.map((g) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="relative group max-w-[160px] z-[99999]">
                          <div 
                          ...
                          {g.aiInsights?.summary && (
                            <div className="absolute bottom-full left-0 mb-4 hidden group-hover:block z-[99999] w-72 p-4 bg-slate-900 text-white rounded-2xl shadow-2xl animate-in fade-in zoom-in-95 duration-200 pointer-events-none border border-white/10 ring-1 ring-black/5">
